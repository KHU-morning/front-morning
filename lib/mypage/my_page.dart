        ...
        children: [
          Row(
            children: [
                    CircleAvatar(
                    radius: 28,
                    backgroundImage: AssetImage('img/${profile?['username']}.png').assetName != null
                      ? AssetImage('img/${profile?['username']}.png')
                      : AssetImage('img/default_profile.png') as ImageProvider,
                    ),
